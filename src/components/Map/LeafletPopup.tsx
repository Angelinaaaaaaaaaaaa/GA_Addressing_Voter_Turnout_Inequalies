...
const LeafletPopup = ({
    ...
    const {
        ...
        vote_center_id,
        municipal_precinct,
        advanced_polling_place,
        polling_place_status,
        classification,
    } = item
        ...
        <Popup {...props}>
            ...
            >
                <div className="flex flex-row justify-center pt-3" style={{width: '300px'}}>
                    ...
                    >
                        <h5 className="m-0 text-lg font-bold leading-none">{title}</h5>
                        <p className="m-0 text-secondary">{address}</p>
                        <p className="m-0 text-secondary">County: {county}</p>
                        <p className="m-0 text-secondary">Vote Center ID: {vote_center_id}</p>
                        <p className="m-0 text-secondary">County Precinct: {municipal_precinct}</p>
                        <p className="m-0 text-secondary">Advanced Polling Place: {advanced_polling_place}</p>
